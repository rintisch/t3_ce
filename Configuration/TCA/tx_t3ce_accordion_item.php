...
return [
    'ctrl' => [
        ...
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
        'title' => 'LLL:EXT:t3_ce/Resources/Private/Language/locallang_be.xlf:accordion_item',
        'delete' => 'deleted',
        'versioningWS' => true,
        'origUid' => 't3_origuid',
        'hideTable' => true,
        ...
        'typeicon_classes' => [
            'default' => 'content-t3ce-accordion-item',
        ]
    ],
    'interface' => [
        'showRecordFieldList' => '
    ...
    'palettes' => [
        ...
        'visibility' => [
            'showitem' => '
                hidden;LLL:EXT:t3_ce/Resources/Private/Language/locallang_be.xlf:accordion_item
            '
        ],
    ...
    'columns' => [
        'tt_content' => [
            'exclude' => true,
            'label' => 'LLL:EXT:t3_ce/Resources/Private/Language/locallang_be.xlf:accordion_item.tt_content',
            'config' => [
                'type' => 'select',
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_t3ce_accordion_item.pid=###CURRENT_PID### AND tx_t3ce_accordion_item.sys_language_uid IN (-1,0)',
                'default' => 0
            ]
        ],
        'l10n_diffsource' => [
        ...
        'header' => [
            'exclude' => true,
            'label' => 'LLL:EXT:t3_ce/Resources/Private/Language/locallang_be.xlf:accordion_item.header',
            'config' => [
                'type' => 'input',
                'size' => 50,
                'eval' => 'trim'
        ...
        'bodytext' => [
            'label' => 'LLL:EXT:t3_ce/Resources/Private/Language/locallang_be.xlf:accordion_item.bodytext',
            'l10n_mode' => 'prefixLangTitle',
            'l10n_cat' => 'text',
            'config' => [
                'type' => 'text',
        ...
        'media' => [
            'exclude' => true,
            'label' => 'LLL:EXT:t3_ce/Resources/Private/Language/locallang_be.xlf:accordion_item.media',
